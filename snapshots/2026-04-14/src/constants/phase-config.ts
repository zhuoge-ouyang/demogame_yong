...
export const PHASES: PhaseConfig[] = [
  {
    ...
    modules: [
      ...
      { key: 'main-storyline', label: '主线三阶段目标', route: '/phase1/main-storyline', description: '主线剧情在三个阶段中的核心目标梳理' },
      ...
      { key: 'castle-goddess', label: '城堡与女神设定', route: '/phase1/castle-goddess', description: '城堡机制与女神NPC的设计' }
    ]
  },
  {
    id: 2,
